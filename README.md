...
[![build](https://github.com/nguoianphu/docker-wine/actions/workflows/build.yml/badge.svg)](https://github.com/nguoianphu/docker-wine/actions/workflows/build.yml)
[![Docker Pulls](https://img.shields.io/docker/pulls/nguoianphu/docker-wine.svg?style=social)](https://hub.docker.com/r/nguoianphu/docker-wine)
[![Docker Stars](https://img.shields.io/docker/stars/nguoianphu/docker-wine.svg?style=social)](https://hub.docker.com/r/nguoianphu/docker-wine)
[![GitHub forks](https://img.shields.io/github/forks/nguoianphu/docker-wine.svg?style=social)](https://github.com/nguoianphu/docker-wine/network)
[![GitHub stars](https://img.shields.io/github/stars/nguoianphu/docker-wine.svg?style=social)](https://github.com/nguoianphu/docker-wine/stargazers)

<img align="right" height="300" width="300" src="https://raw.githubusercontent.com/nguoianphu/docker-wine/master/images/logo.png" >
...
```bash
wget https://raw.githubusercontent.com/nguoianphu/docker-wine/master/docker-wine
chmod +x docker-wine
```
...
```bash
curl -O https://raw.githubusercontent.com/nguoianphu/docker-wine/master/docker-wine
chmod +x docker-wine
```
...
![Screenshot of Notepad](https://raw.githubusercontent.com/nguoianphu/docker-wine/master/images/screenshot_1.png)
...
![Screenshot of login prompt](https://raw.githubusercontent.com/nguoianphu/docker-wine/master/images/screenshot_2.png)

![Screenshot of XFCE desktop](https://raw.githubusercontent.com/nguoianphu/docker-wine/master/images/screenshot_3.png)
...
```bash
git clone https://github.com/nguoianphu/docker-wine.git
cd docker-wine
```
...
If you plan to use `nguoianphu/docker-wine` as a base for another Docker image, you should set up the same `ENTRYPOINT` to enable X11 forwarding and RDP server modes to continue operating:

```dockerfile
FROM nguoianphu/docker-wine:latest
... <your code here>
...
```bash
docker pull nguoianphu/docker-wine
```
...
docker run -it \
  ...
  nguoianphu/docker-wine /bin/bash
```
